...
PRODUCT_COPY_FILES += \
	...
	device/huawei/viva/audio/huawei/audio/mk_viva_audio_config.conf:system/etc/huawei/audio/cm_viva_audio_config.conf \
	...
	device/huawei/viva/other/cmfm:system/bin/cmfm
# OTHER
PRODUCT_COPY_FILES += \
	device/huawei/viva/other/hosts:system/etc/hosts \
	device/huawei/viva/other/10frandom:system/etc/init.d/10frandom

# Timezones
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/timezones/tzdata:system/usr/share/zoneinfo/tzdata \
    $(LOCAL_PATH)/timezones/icudt51l.dat:system/usr/icu/icudt51l.dat
...
ADDITIONAL_DEFAULT_PROPERTIES := \
	ro.build.display.id=romfor_build \
	ro.adb.secure=0 
